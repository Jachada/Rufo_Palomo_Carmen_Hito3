          ...
          <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
            ...
            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
              ...
              <li>
                ...
                <li class="w-100">
                    <a href="/administracion/incidencias" class="nav-link px-0"> <span class="d-none d-sm-inline">Todas (funciona)</span></a>
                  </li>
                  <li class="w-100">
                    <a href="#" class="nav-link px-0"> <span class="d-none d-sm-inline">Creadas</span></a>
                  </li>
                  <li>
                    <a href="#" class="nav-link px-0"> <span class="d-none d-sm-inline">En Progreso</span></a>
                  </li>
                  <li>
                    <a href="#" class="nav-link px-0"> <span class="d-none d-sm-inline">Resueltas</span></a>
                  </li>
                  <li>
                    <a href="#" class="nav-link px-0"> <span class="d-none d-sm-inline">Derivadas</span></a>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <li class="w-100">
                    <a href="/administracion/usuarios" class="nav-link px-0"> <span class="d-none d-sm-inline">Todos (funciona)</span></a>
                  </li>
                  <li class="w-100">
